...
export namespace Spritesheets {
    export class SpritesheetsAlien10010018 {
        static getName(): string { return 'alien.[100,100,18,0]'; }

        static getPNG(): string { return require('assets/spritesheets/alien.[100,100,18,0].png'); }
    ...
    export class SpritesheetsChicken10010013 {
        static getName(): string { return 'chicken.[100,100,13,0,0]'; }

        static getPNG(): string { return require('assets/spritesheets/chicken.[100,100,13,0,0].png'); }
        static getFrameWidth(): number { return 100; }
        static getFrameHeight(): number { return 100; }
...
export namespace Audio {
    export class AudioChickenThrow {
        static getName(): string { return 'chicken-throw'; }

        static getMP3(): string { return require('assets/audio/chicken-throw.mp3'); }
    }
    export class AudioExplotion {
        static getName(): string { return 'explotion'; }

        static getMP3(): string { return require('assets/audio/explotion.mp3'); }
    }
